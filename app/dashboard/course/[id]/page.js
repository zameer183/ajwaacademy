      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 py-8">
          ...
          <div className="lg:col-span-3">
            <div className="bg-slate-900/90 border border-white/10 rounded-lg overflow-hidden mb-4 shadow-xl">
              {/* Video Container */}
            ...
            {/* Notes Panel */}
            {showNotes && (
              <div className="bg-slate-900 rounded-lg p-6 mt-4 shadow-lg">
